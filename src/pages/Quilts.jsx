...
const QUILTS = [
  {
    ...
    price: 179,
    name: "Classic Satin Quilt",
    description:
      "Lightweight quilt with a smooth satin finish and comfortable warmth.",
  },
  {
    id: 2,
    ...
    fillMaterial: "Microfiber",
    price: 159,
    name: "Striped Weave Quilt",
    description:
      "Subtle woven stripe texture with lightweight breathable warmth.",
  },
  {
    id: 3,
    ...
    description:
      "Breathable cotton cover, soft texture and comfortable year-round warmth.",
  },
];
    ...
    <section className="bg-[#f4eadc] min-h-screen pt-32 pb-20 px-8 sm:px-10 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="text-gray-500 text-lg max-w-2xl leading-relaxed mb-10">
          {t("quilts.description")}
        </p>

        {/* Cover material filters */}
          ...
          {COVER_MATERIALS.map((material) => {
            ...
            return (
              ...
              >
                ...
                >
                  {t(`quilts.materials.${material.key}`)}
                </span>
              </button>
            );
          })}
        ...
        {filteredQuilts.length > 0 ? (
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[11px] tracking-[2px] text-[#b18a42]">
                      {t(
                        `quilts.materials.${quilt.coverMaterial}`
                      )}{" "}
                      {t("quilts.cover_label")}
                    </span>

                    <span className="text-gray-300">•</span>

                    <span className="text-[11px] tracking-[2px] text-gray-400">
                      {quilt.fillMaterial.toUpperCase()}{" "}
                      {t("quilts.fill_label")}
                    </span>
                  </div>
          ...
          <div className="flex flex-col items-center justify-center text-center py-24 border border-dashed border-[#d3b98a] rounded-2xl">
            <p className="font-['Cormorant_Garamond'] text-3xl text-[#8d6a2b] mb-3">
              {t("quilts.sorry.heading")}
            </p>

            <p className="text-gray-500 max-w-md">
              {t("quilts.sorry.message", {
                material: t(
                  `quilts.materials.${selectedMaterial}`
                ),
              })}
            </p>
          </div>
